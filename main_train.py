...
#model = segnet(pretrained_weights = 'segnet_mydata.hdf5' ,input_size = (img_h,img_w,1))
model = segnet(input_size = (img_h,img_w,1))
model_checkpoint = ModelCheckpoint('segnet_mydata.hdf5', monitor='loss',verbose=1, save_best_only=True)
